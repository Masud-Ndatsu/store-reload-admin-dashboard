...
export const CategoryForm = React.memo(function CategoryForm() {
    ...
    const { isCategoryModal, setIsCategoryModal, getCategories } = useCategoryData();
    ...
    return (
        <Modal isOpen={isCategoryModal} onClose={() => setIsCategoryModal(false)} style={{ height: "500px" }}>
            <div style={{ textAlign: "center" }}>
                <h1>Create new Category</h1>
                <form style={{ padding: "2rem" }} onSubmit={handleCategoryReq}>
                    <div>
                        <label
                            htmlFor="category"
                            style={{
